...
import {configurarAcessoMapaOnr, iniciarMapaOnr, limparMapaOnr} from './mapa_onr.js?v=20260901-nativo-v1-api1';
import {carregarCustas, iniciarCustas, limparCustas} from './custas.js?v=20260902-pesquisa-na-importacao';
import {carregarIntimacoes, iniciarIntimacoes, limparIntimacoes} from './intimacoes.js?v=20260831-setores-v1-api1';
import {iniciarNavegacao} from './navegacao.js?v=20260831-setores-v1';
import {carregarPainel, iniciarPainel, limparPainel} from './painel.js?v=20260831-setores-v1-api1';
import {carregarSistema, iniciarSistema, limparSistema} from './sistema.js?v=20260831-setores-v1-api1';
import {iniciarContratos, limparContratos} from './contratos.js?v=20260902-copia-iframe-v1-api1';
import {carregarPoligonos, configurarAcessoPoligonos, iniciarPoligonos, limparPoligonos} from './poligonos.js?v=20260819-poligonos-v13-api1';
import {carregarRegistrosAuxiliares, iniciarRegistrosAuxiliares, limparRegistrosAuxiliares} from './registros_auxiliares.js?v=20260827-operacao-v1-api1';
